...
def insert_into_postgres(table: str, **kwargs):
    ...
    for _, row in df.iterrows():
            cursor.execute(
                ...
                product_id, transaction_qty, unit_price, product_category, product_type, product_detail, size, total_bill, 
                month_name, day_name, hour, day_of_week, month, time_stamp)
